...
public class WindowManager {
     ...
     */
    public WindowManager(TrackFactory addFactory) {
        this.addFactory = addFactory;
    }

    /**
     * @brief Inietta il MainController una volta che l'interfaccia è stata
     *        caricata.
     */
     ...
     */
    public void openTrackWindow(String fxmlPath, String title, Track trackToModify) {
        try {
    ...
    /**
     * @brief Apre la finestra per aggiungere brani a una playlist esistente.
     * @param selectedPlaylist Playlist di destinazione; se null non viene
     *                         aperta alcuna finestra.
     */
    public void openAddTrackToPlaylistWindow(Playlist selectedPlaylist) {
        if (selectedPlaylist == null) {
            System.out.println("Nessuna playlist selezionata per l'aggiunta di brani.");
            return;
        }
        try {
            ...
            controller.initData(mainController, selectedPlaylist);
            ...
            System.err.println("Errore nel caricamento di AddTrackToPlaylistView: " + e.getMessage());
        }
    }
